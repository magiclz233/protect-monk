...
```text
我在为一款《守护唐僧》Q版西游合成塔防微信小游戏生成可商用2D游戏素材。整体风格请统一为Q版西游、国风2D、移动端小游戏资产；角色头大身小，Q版比例适中，线条干净，平涂色块为主带轻微明暗层次，颜色鲜明，小尺寸也能识别；不要生硬剪纸轮廓，也不要过度圆润立体；透明背景，无文字，无水印，不模仿任何已有游戏、动画、电影或版权角色风格。
```
...
1. 相同的Q版头身比和身体比例。
2. 相同的线条粗细、描边方式和阴影方式。
3. 相同的颜色饱和度、明暗对比和国风2D平涂质感。
4. 相同的45度轻俯视棋盘视角和角色朝向。
5. 相同的小尺寸可读性，适合80x80或96x96棋盘格。
6. 相同的2D平涂风格，不要生硬剪纸轮廓，也不要过度圆润立体。

允许改变：
角色身份、武器、服装元素、主色、动作阶段、攻击特效。

禁止改变：
不要变成像素风、厚涂、写实、3D、欧美魔幻、现代卡通、过度复杂细节、过暗配色、不同镜头角度、剪纸风格、皮影戏风格、扁平剪影风格、过度圆润立体风格。
```
...
```text
为一款《守护唐僧》西游题材 Q 版合成塔防微信小游戏生成正式美术资源。整体风格为 Q 版西游、国风2D、移动端小游戏资产。所有角色头大身小，Q版比例适中，线条干净，平涂色块为主带轻微明暗层次，轮廓清晰，颜色鲜明，高对比，小尺寸也能识别。不要生硬剪纸轮廓，也不要过度圆润立体。视角为轻微 45 度俯视棋盘视角，适合放入 80x80 或 96x96 棋盘格。画面为 2D sprite，美术统一，不要写实，不要 3D，不要复杂背景，不要文字，不要水印，不要 logo，不要模仿任何已有游戏、动画、电影或版权角色风格。单体静态资源输出单张透明背景 PNG；多个静态资源输出等格 sheet 后裁切；动作和特效优先输出横向 PNG sprite sheet；如果工具无法输出一张 sheet，则输出同一动作或特效的编号透明 PNG 帧序列。
```

### 7. 图片反向提示词

```text
写实照片，3D渲染，厚涂，复杂背景，灰白棋盘格背景，文字，水印，logo，模糊，低清晰度，恐怖血腥，过多细节，暗色过重，版权角色，已有游戏角色风格，动画截图，电影截图，像素风，赛博朋克，欧美魔幻，现代服装，剪纸风格，皮影戏风格，扁平剪影，纸片人，轮廓过于生硬
```
...
```text
生成一张透明背景 2D mobile game UI asset sheet，内容是《守护唐僧》Q版西游塔防卡牌和仓库 UI 组件。所有组件独立摆放、不要重叠，组件周围留透明边距，后续会裁成单张 PNG。Q版国风和棋盘塔防风格，颜色为金色、朱红、青绿、墨蓝。包含：小兵卡牌框，英雄碎片卡牌框，道具卡牌框，普通英雄青绿色边框，核心英雄金红边框，仓库空槽，仓库高亮槽，召唤按钮，广告奖励按钮，禁用按钮。所有组件无文字，无水印，边缘清晰，适合微信小游戏 UI。
```
...
```text
生成一张透明背景 2D mobile game UI panel sheet，内容是《守护唐僧》Q版西游塔防 HUD 和结算界面组件。所有组件独立摆放、不要重叠，组件周围留透明边距，后续会裁成单张 PNG。Q版国风轻量质感。包含：顶部 HUD 长条背景，资源小面板，血量小面板，波次小面板，BOSS 血条背景，BOSS 血条填充，胜利结算面板，失败结算面板，普通按钮，确认按钮，返回按钮，星级展示底板。颜色使用墨蓝底、金色描边、朱红强调、青绿辅助。无文字，无水印，透明背景。
```
...
```text
生成一张竖屏手机游戏背景图，尺寸 750x1334，主题是《守护唐僧》西游取经路线图，Q版国风手绘地图风格。画面表现从五行山下到高老庄的取经路线，山路、云纹、庙宇、村庄、卷轴地图感，适合作为前十八难关卡地图背景。中间预留清晰路线节点位置，底部预留按钮区域，顶部预留标题区域。不要文字，不要水印，不要 logo，不要角色版权风格。
```
...
```text
生成一张竖屏手机游戏战斗背景图，尺寸 750x1334，主题是《守护唐僧》Q版西游塔防战斗场景，国风2D场景风格。中间区域预留 8x6 棋盘，背景为山野林地和取经道路，氛围有妖怪来袭的紧张感但不恐怖，红金路线和青绿可布阵区域能清楚显示，底部预留召唤卡牌栏和仓库栏，顶部预留 HUD。不要文字，不要水印，不要 logo，不要复杂细节，保持 Q 版西游统一风格。
```
...
英雄和 BOSS 的战斗特效分**三个阶段**，每个阶段需要独立的视觉资源：

```text
阶段一：起手（发射点）  →  英雄播放 attack 动画（已有），攻击拖尾/发射光圈（本节生成）
阶段二：飞行（投射物）  →  箭矢/火球/法术弹从英雄飞向目标（本节生成）
阶段三：命中（目标点）  →  命中火花/爆炸/冲击波在敌人身上播放（本节生成）
```

以二郎神为例：二郎神在远处拉弓→射出一支光箭→光箭飞行穿过棋盘→命中小怪时爆开光效。这三个阶段缺一不可。

---

### 1. 通用环境特效

资源类型：图片，透明背景 PNG sprite sheet。不要生成视频、GIF 或 MP4。
...
```text
生成一张透明背景 2D VFX sprite sheet，内容是《守护唐僧》Q版西游塔防通用环境特效。每个特效 6 帧横向排列，每帧 128x128，单个特效整张最终尺寸 768x128；如果一张图里放多个特效，请每个特效单独一行。风格为Q版国风、明亮高对比、移动端可读。包含：金色召唤光圈，绿色合成升级光圈，英雄激活金红双环，英雄升级金色上升光柱，莲花治疗光效，BOSS 入场红金冲击波，道具使用闪光。每个特效独立居中，无文字，无水印，透明背景。
```
...
这些是飞行中的攻击弹道，从英雄飞向敌人。每种投射物独立生成一个 sprite sheet 或帧序列。

输出文件：

```text
public/assets/effects/effect_projectile_arrow.png
public/assets/effects/effect_projectile_fireball.png
public/assets/effects/effect_projectile_magic.png
public/assets/effects/effect_projectile_staff.png
public/assets/effects/effect_projectile_water.png
```

提示词：

```text
生成【箭矢投射物】Q版西游塔防飞行弹道特效，一张横向连续 4 帧 PNG sprite sheet，透明背景。每帧 64x64，整张最终尺寸 256x64。如果无法输出一张 sheet，请输出 4 张按编号命名的透明单帧 PNG。画面内容：一支金色/白色光箭，水平向右飞行，箭身带流光拖尾，箭尖有星芒闪烁感，4 帧为飞行中轻微上下浮动和尾迹流动。用于二郎神、白龙马、道法弓手的远程普攻弹道。无文字，无水印，透明背景。
```

```text
生成【火球投射物】Q版西游塔防飞行弹道特效，一张横向连续 4 帧 PNG sprite sheet，透明背景。每帧 64x64，整张最终尺寸 256x64。如果无法输出一张 sheet，请输出 4 张按编号命名的透明单帧 PNG。画面内容：一颗红橙色火球，水平向右飞行，火球带燃烧拖尾和火星溅射，4 帧为火焰跳动和拖尾流动。用于红孩儿普攻和技能弹道。无文字，无水印，透明背景。
```

```text
生成【法术弹投射物】Q版西游塔防飞行弹道特效，一张横向连续 4 帧 PNG sprite sheet，透明背景。每帧 64x64，整张最终尺寸 256x64。如果无法输出一张 sheet，请输出 4 张按编号命名的透明单帧 PNG。画面内容：一颗青绿色/蓝紫色法术能量弹，水平向右飞行，带星光拖尾和能量波纹，4 帧为能量弹脉动和尾迹闪烁。用于观音、哪吒、太上老君等法术英雄的远程弹道。无文字，无水印，透明背景。
```

```text
生成【棍影投射物】Q版西游塔防飞行弹道特效，一张横向连续 4 帧 PNG sprite sheet，透明背景。每帧 64x64，整张最终尺寸 256x64。如果无法输出一张 sheet，请输出 4 张按编号命名的透明单帧 PNG。画面内容：一道金色棍形冲击波，水平向右飞行，带金光拖尾和能量纹路，4 帧为棍影旋转和光纹流动。用于孙悟空技能的远程冲击弹道。无文字，无水印，透明背景。
```

```text
生成【水弹投射物】Q版西游塔防飞行弹道特效，一张横向连续 4 帧 PNG sprite sheet，透明背景。每帧 64x64，整张最终尺寸 256x64。如果无法输出一张 sheet，请输出 4 张按编号命名的透明单帧 PNG。画面内容：一颗蓝白色水弹，水平向右飞行，带水纹拖尾和水滴溅射，4 帧为水波流动。用于沙悟净减速水弹等远程弹道。无文字，无水印，透明背景。
```
...
这些是攻击命中敌人时在目标身上播放的爆开/打击特效。

输出文件：

```text
public/assets/effects/effect_hit_melee.png
public/assets/effects/effect_hit_arrow.png
public/assets/effects/effect_hit_fire.png
public/assets/effects/effect_hit_magic.png
public/assets/effects/effect_hit_crit.png
```

提示词：

```text
生成【近战命中特效】Q版西游塔防打击火花，一张横向连续 6 帧 PNG sprite sheet，透明背景。每帧 96x96，整张最终尺寸 576x96。如果无法输出一张 sheet，请输出 6 张按编号命名的透明单帧 PNG。画面内容：金色/白色斩击火花爆开，从中心点向外扩散星形光芒和碎片粒子，6 帧为火花从小变大再消散。用于孙悟空棍击、猪八戒钉耙、黑熊精重击等近战命中反馈。不能血腥。无文字，无水印，透明背景。
```

```text
生成【箭矢命中特效】Q版西游塔防箭矢命中，一张横向连续 6 帧 PNG sprite sheet，透明背景。每帧 96x96，整张最终尺寸 576x96。如果无法输出一张 sheet，请输出 6 张按编号命名的透明单帧 PNG。画面内容：金色/白色光点爆开，带环形冲击波和细小光粒向外飞散，6 帧为光点从小变大再消散。用于二郎神、白龙马、道法弓手的远程攻击命中反馈。不能血腥。无文字，无水印，透明背景。
```

```text
生成【火焰命中特效】Q版西游塔防火焰爆裂，一张横向连续 6 帧 PNG sprite sheet，透明背景。每帧 96x96，整张最终尺寸 576x96。如果无法输出一张 sheet，请输出 6 张按编号命名的透明单帧 PNG。画面内容：红橙色火焰从命中点向外爆开，带火星和热浪扩散，6 帧为火焰膨胀再收缩消散。用于红孩儿、太上老君火焰攻击命中反馈。不能血腥。无文字，无水印，透明背景。
```

```text
生成【法术命中特效】Q版西游塔防法术命中，一张横向连续 6 帧 PNG sprite sheet，透明背景。每帧 96x96，整张最终尺寸 576x96。如果无法输出一张 sheet，请输出 6 张按编号命名的透明单帧 PNG。画面内容：青绿色/蓝紫色法术能量从命中点向外扩散，带星光粒子和环形符文波纹，6 帧为能量环从小到大再消散。用于观音、哪吒等法术攻击命中反馈。不能血腥。无文字，无水印，透明背景。
```

```text
生成【暴击命中特效】Q版西游塔防暴击大数字，一张横向连续 6 帧 PNG sprite sheet，透明背景。每帧 96x96，整张最终尺寸 576x96。如果无法输出一张 sheet，请输出 6 张按编号命名的透明单帧 PNG。画面内容：比普通命中更大、更亮的金色/红色爆裂光芒，带十字星芒和多层冲击波，6 帧从强烈闪光爆发到消散，要有明显的"重击感"。用于暴击时的命中反馈。不能血腥。无文字，无水印，透明背景。
```
...
这些是在英雄身边播放的发射/起手特效，配合 attack 动画一起使用。

输出文件：

```text
public/assets/effects/effect_launch_arrow.png
public/assets/effects/effect_launch_fire.png
public/assets/effects/effect_launch_melee.png
public/assets/effects/effect_launch_magic.png
```

提示词：

```text
生成【弓箭发射特效】Q版西游塔防弓箭起手，一张横向连续 4 帧 PNG sprite sheet，透明背景。每帧 96x96，整张最终尺寸 384x96。如果无法输出一张 sheet，请输出 4 张按编号命名的透明单帧 PNG。画面内容：弓弦释放瞬间的金色/白色光圈从弓臂处向外扩散，带细小光粒和弓弦震动感，4 帧为光圈快速出现再消散。此特效放在射手身前，配合 attack 动画使用。无文字，无水印，透明背景。
```

```text
生成【火焰发射特效】Q版西游塔防火焰起手，一张横向连续 4 帧 PNG sprite sheet，透明背景。每帧 96x96，整张最终尺寸 384x96。如果无法输出一张 sheet，请输出 4 张按编号命名的透明单帧 PNG。画面内容：施法者身前出现红橙火焰旋涡凝聚，然后向前喷发，带火星四溅，4 帧为火焰凝聚到喷出。此特效放在施法者身前。无文字，无水印，透明背景。
```

```text
生成【近战挥砍特效】Q版西游塔防近战起手，一张横向连续 4 帧 PNG sprite sheet，透明背景。每帧 96x96，整张最终尺寸 384x96。如果无法输出一张 sheet，请输出 4 张按编号命名的透明单帧 PNG。画面内容：一道金色/白色弧形斩击刀光在武器挥动轨迹上闪出，从左到右或从右上到左下的弧线，4 帧为弧光闪现到消散。此特效覆盖在武器挥动轨迹上。无文字，无水印，透明背景。
```

```text
生成【法术发射特效】Q版西游塔防法术起手，一张横向连续 4 帧 PNG sprite sheet，透明背景。每帧 96x96，整张最终尺寸 384x96。如果无法输出一张 sheet，请输出 4 张按编号命名的透明单帧 PNG。画面内容：施法者身前出现青绿色/金色法术阵或符文光圈凝聚，然后向前射出能量，带星光粒子，4 帧为法阵凝聚到射出。此特效放在施法者身前。无文字，无水印，透明背景。
```
...
```text
public/assets/effects/effect_aoe_fire_burst.png
public/assets/effects/effect_aoe_slow_mist.png
public/assets/effects/effect_aoe_ring_splash.png
```

提示词：

```text
生成【火焰范围爆裂】Q版西游塔防范围火焰特效，一张横向连续 6 帧 PNG sprite sheet，透明背景。每帧 128x128，整张最终尺寸 768x128。如果无法输出一张 sheet，请输出 6 张按编号命名的透明单帧 PNG。画面内容：红橙色火焰从中心向周围圆形扩散爆开，带热浪波纹和火星，6 帧为火焰圈快速扩散再消散。用于红孩儿技能群攻、太上老君灼烧范围。无文字，无水印，透明背景。
```

```text
生成【减速冰雾范围】Q版西游塔防减速区域特效，一张横向连续 6 帧 PNG sprite sheet，透明背景。每帧 128x128，整张最终尺寸 768x128。如果无法输出一张 sheet，请输出 6 张按编号命名的透明单帧 PNG。画面内容：蓝白色冰冷雾气在地面圆形区域内旋转扩散，带冰晶粒子和小雪花，6 帧为雾气循环流动，首尾可循环。用于沙悟净减速水纹、蜘蛛精减速蛛网等。无文字，无水印，透明背景。
```

```text
生成【环形冲击波】Q版西游塔防范围冲击特效，一张横向连续 6 帧 PNG sprite sheet，透明背景。每帧 128x128，整张最终尺寸 768x128。如果无法输出一张 sheet，请输出 6 张按编号命名的透明单帧 PNG。画面内容：一道金色/红金色冲击波圆环从中心向外扩散，带能量纹路和细小光粒，6 帧为冲击环快速扩大再消散。用于 BOSS 重击溅射、牛魔王范围技等。无文字，无水印，透明背景。
```
