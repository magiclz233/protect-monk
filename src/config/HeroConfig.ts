/**
 * 英雄数值配置表：14 名英雄，含 7 名核心英雄与 7 名普通英雄。
 */
...
export const HERO_CONFIGS: HeroConfigItem[] = [
  {
    ...
    role: '近战爆发', passive: '对 BOSS 伤害 +50%，攻击有 30% 概率暴击',
  ...
  },
  {
    ...
    role: '治疗辅助', passive: '周围 2 格友军每秒回复 5% 最大血量，在场享受光环经验',
    description: '普度众生，庇护四方。', unlockChapter: 6,
  },
  {
    ...
    role: '狂暴坦克', passive: '血量低于 30% 时，自身伤害翻倍',
    description: '上古妖王，不死不休。', unlockChapter: 5,
  },
  {
    ...
    description: '三昧真火，燃尽一切。', unlockChapter: 4,
  },
  {
  ...
  },
  {
    ...
    role: '持续输出', passive: '攻击附带灼烧效果，3 秒内持续掉血',
  ...
  },
  {
    ...
    role: '中距控制', passive: '攻击附带 30% 减速，自身免伤 +20%',
    description: '卷帘大将，稳如磐石。', unlockChapter: 2,
  },
  {
    ...
    role: '远程穿透', passive: '攻击可穿透 3 个敌人，攻速提升 25%',
    description: '龙马精神，贯纵连横。',
  },
  {
    ...
    role: '物理肉盾', passive: '高物防，反弹 25% 受到的物理伤害',
  ...
  },
  {
    ...
    role: '召唤输出', passive: '每隔 15 秒召唤 1 个分身作战，分身拥有本体 30% 属性',
    description: '虚实莫测，以一化三。', unlockChapter: 3,
  },
  {
    ...
    role: '范围减速', passive: '自身 3 格范围内，敌人移速降低 30%',
    description: '天罗地网，寸步难行。', unlockChapter: 7,
  },
  {
    ...
    role: '群体控制', passive: '攻击有 15% 概率定身敌人 1.5 秒',
    description: '宝塔镇妖，定身乾坤。',
  },
];
...
export function toHeroStats(config: HeroConfigItem): HeroStats {
  return {
    ...
    shardsNeeded: config.shardsNeeded,
